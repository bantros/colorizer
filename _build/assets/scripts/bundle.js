...
/***/ function(module, exports, __webpack_require__) {
	...
	var Colorizer = exports.Colorizer = {
	  ...
	  attachEventListner: function attachEventListner() {

	    document.getElementById('js-btn--random').addEventListener('click', Colorizer.createSwatchList, false);

	    for (var i = 0; i < document.getElementsByClassName('btn--swatch').length; i++) {
